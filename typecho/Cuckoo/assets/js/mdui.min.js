...
!(function(t, e) {
  ...
  var e = (function() {
      function t(e) {
        ...
        if ("string" == typeof e) {
          ...
          if ("<" === i[0] && ">" === i[i.length - 1]) {
            ...
            a.innerHTML = i;
            for (var s = 0; s < a.childNodes.length; s += 1)
          ...
          if ("function" == typeof e) return t(document).ready(e);
          if (e.nodeType || e === window || e === document) n.push(e);
          else if (e.length > 0 && e[0].nodeType)
            for (var c = 0; c < e.length; c += 1) n.push(e[c]);
        }
        return new $(n);
      }
      function e() {
        ...
        if (1 === e.length)
          return (
            Object.keys(e[0]).forEach(function(n) {
              t[n] = e[0][n];
            }),
            this
          );
        for (var i = e.shift(), o = 0; o < e.length; o += 1)
          !(function(t) {
      ...
      function u(t, e) {
        ...
        return (
          c(t, function(t, n) {
            null !== (i = e(n, t)) && void 0 !== i && o.push(i);
          }),
          (n = []).concat.apply(n, o)
        );
      }
      ...
      function h(e, n, i, o) {
        ...
        return (
          e.each(function(e, r) {
            for (a = r[o]; a; ) {
              if (2 === i) {
                if (!n || (n && t(a).is(n))) break;
                s.push(a);
              } else {
                if (0 === i) {
                  (!n || (n && t(a).is(n))) && s.push(a);
                  break;
                }
                (!n || (n && t(a).is(n))) && s.push(a);
              }
      ...
      function v(t) {
        return (
          t.mduiElementId || ((T += 1), (t.mduiElementId = T)), t.mduiElementId
        );
      }
      function g(t, e, n, i) {
        return (O[v(t)] || []).filter(function(t) {
          return (
            t &&
            (!e || t.e === e) &&
            (!n || t.fn.toString() === n.toString()) &&
            (!i || t.sel === i)
          );
        });
      }
      function b(e, n, o, a, s) {
        var r = v(e);
        O[r] || (O[r] = []);
        var d = !1;
        i(a) && a.useCapture && (d = !0),
              ...
              (n._data = a),
                s
                  ? t(e)
                      ...
                      .reverse()
                      .forEach(function(e) {
                        (e === n.target || t.contains(e, n.target)) && i(n, e);
                      })
                  : i(n, e);
            }
            var u = { e: n, fn: o, sel: s, i: O[r].length };
            (u.proxy = c), O[r].push(u), e.addEventListener(u.e, c, d);
          });
      }
      function x(t, e, n, i) {
        (e || "").split(" ").forEach(function(e) {
          g(t, e, n, i).forEach(function(e) {
            delete O[v(t)][e.i], t.removeEventListener(e.e, e.proxy, !1);
          });
        });
      }
      function y(t) {
      ...
      (t.fn = $.prototype), (t.fn.extend = e), (t.extend = e);
      var C = {};
      t.extend({
        each: c,
        merge: l,
        ...
        param: function(t) {
          function e(t, o) {
            ...
            i(o)
              ? c(o, function(n, s) {
                  (a = Array.isArray(o) && !i(s) ? "" : n),
                    e(t + "[" + a + "]", s);
                })
              : ((a =
                  null !== o && "" !== o ? "=" + encodeURIComponent(o) : ""),
        ...
        t.fn.extend({
          ...
          filter: function(e) {
            ...
            return this.map(function(t, e) {
              return n.index(e) > -1 ? e : void 0;
            });
          },
          not: function(t) {
            var e = this.filter(t);
            return this.map(function(t, n) {
              return e.index(n) > -1 ? void 0 : n;
            });
          },
          offset: function() {
            if (this[0]) {
          ...
          position: function() {
            ...
            return (
              "fixed" === t.css("position")
                ...
                : ((e = t.offsetParent()),
                  (i = t.offset()),
                  n(e[0], "html") || (o = e.offset()),
                  (o = {
                    top: o.top + e.css("borderTopWidth"),
                    left: o.left + e.css("borderLeftWidth")
                  })),
              {
                top: i.top - o.top - t.css("marginTop"),
                left: i.left - o.left - t.css("marginLeft"),
                width: i.width,
                height: i.height
              }
            );
          ...
          find: function(t) {
            ...
            return (
              this.each(function(n, i) {
                var o = i.nodeType;
                (1 !== o && 9 !== o) || l(e, i.querySelectorAll(t));
              }),
              new $(e)
            );
          },
          children: function(e) {
            ...
            return (
              this.each(function(i, o) {
                c(o.childNodes, function(i, o) {
                  1 === o.nodeType && (!e || (e && t(o).is(e))) && n.push(o);
                });
              }),
              new $(f(n))
            );
          ...
          has: function(e) {
            var n = a(e) ? this.find(e) : t(e),
              i = n.length;
            return this.filter(function() {
              for (var e = this, o = 0; o < i; o += 1)
                if (t.contains(e, n[o])) return !0;
              return !1;
            });
          },
          siblings: function(t) {
          ...
          serializeArray: function() {
            var e = [],
              n = this[0];
            return n && n.elements
              ? (t([].slice.call(n.elements)).each(function() {
                  var n = t(this),
                    i = n.attr("type");
                  "fieldset" === this.nodeName.toLowerCase() ||
                    this.disabled ||
                    -1 !== ["submit", "reset", "button"].indexOf(i) ||
                    (-1 !== ["radio", "checkbox"].indexOf(i) &&
                      !this.checked) ||
          ...
          serialize: function() {
            var t = [];
            return (
              c(this.serializeArray(), function(e, n) {
                t.push(
        ...
        c(["val", "html", "text"], function(e, n) {
          var i = { 0: "value", 1: "innerHTML", 2: "textContent" },
            o = { 0: void 0, 1: void 0, 2: null };
          t.fn[n] = function(t) {
            return void 0 === t
              ? this[0]
                ? this[0][i[e]]
        ...
        c(["add", "remove", "toggle"], function(e, n) {
          t.fn[n + "Class"] = function(t) {
            if (!t) return this;
            var e = t.split(" ");
        ...
        c({ Width: "width", Height: "height" }, function(e, n) {
          t.fn[n] = function(i) {
            if (void 0 === i) {
              var o = this[0];
              if (s(o)) return o["inner" + e];
              if (r(o)) return o.documentElement["scroll" + e];
              var a = t(o),
                d = 0,
                c = "width" === n;
              return (
                "ActiveXObject" in window &&
                  ...
                  (d =
                    parseFloat(a.css("padding-" + (c ? "left" : "top"))) +
                    parseFloat(a.css("padding-" + (c ? "right" : "bottom"))) +
                    parseFloat(
                      a.css("border-" + (c ? "left" : "top") + "-width")
                    ) +
                    parseFloat(
                      a.css("border-" + (c ? "right" : "bottom") + "-width")
                    )),
                parseFloat(t(o).css(n)) + d
              );
            }
            return isNaN(Number(i)) || "" === i || (i += "px"), this.css(n, i);
          };
        }),
        c({ Width: "width", Height: "height" }, function(e, n) {
          t.fn["inner" + e] = function() {
            ...
            return (
              "border-box" !== i.css("box-sizing") &&
                ((e += parseFloat(
                  i.css("padding-" + ("width" === n ? "left" : "top"))
                )),
                (e += parseFloat(
                  i.css("padding-" + ("width" === n ? "right" : "bottom"))
                ))),
              e
            );
          };
        }),
        c(["", "All", "Until"], function(e, n) {
          t.fn["prev" + n] = function(n) {
            return h(
              0 === e ? this : t(this.get().reverse()),
              n,
              e,
        ...
        c(["", "All", "Until"], function(e, n) {
          t.fn["next" + n] = function(t) {
            return h(this, t, e, "nextElementSibling");
          };
        }),
        c(["", "s", "sUntil"], function(e, n) {
          t.fn["parent" + n] = function(n) {
            return h(
              0 === e ? this : t(this.get().reverse()),
              n,
              e,
        ...
        c(["append", "prepend"], function(e, n) {
          t.fn[n] = function(n) {
            var i,
              o = this.length > 1;
            if (a(n)) {
              var s = document.createElement("div");
              (s.innerHTML = n), (i = [].slice.call(s.childNodes));
            } else i = t(n).get();
            return (
              1 === e && i.reverse(),
              this.each(function(t, n) {
                c(i, function(i, a) {
                  o && t > 0 && (a = a.cloneNode(!0)),
                    0 === e
                      ? n.appendChild(a)
        ...
        c(["insertBefore", "insertAfter"], function(e, n) {
          t.fn[n] = function(n) {
            var i = t(n);
      ...
      t.extend({
        ...
        removeData: function(t, e) {
          t[k] && t[k][e] && ((t[k][e] = null), delete t[k][e]);
        }
      }),
        t.fn.extend({
          data: function(e, n) {
      ...
      t.fn.extend({
        ...
        on: function(t, e, n, i, s) {
          ...
          if (
            (a(e) || o(i) || !1 === i || ((i = n), (n = e), (e = void 0)),
            (o(n) || !1 === n) && ((i = n), (n = void 0)),
            !1 === i && (i = m),
            1 === s)
          ) {
            var d = i;
            i = function() {
              return r.off(t, e, i), d.apply(this, arguments);
            };
          }
          return this.each(function() {
            b(this, t, i, n, e);
        ...
        trigger: function(t, e) {
          var n,
            i = ["click", "mousedown", "mouseup", "mousemove"].indexOf(t) > -1;
          return (
            (n = i
              ? new MouseEvent(t, { bubbles: !0, cancelable: !0 })
              : new CustomEvent(t, { detail: e, bubbles: !0, cancelable: !0 })),
            (n._detail = e),
            this.each(function() {
      ...
      return (
        t.extend({
          ...
          ajax: function(e) {
            function n(n, i) {
              e.global && t(document).trigger(n, i);
            }
            function i(t) {
              ...
              var o, a;
              t &&
                (t in u && (o = u[t].apply(u, n)),
                e[t] && (a = e[t].apply(e, n)),
                "beforeSend" !== t || (!1 !== o && !1 !== a) || (d = !0));
            }
            var s = {
                method: "GET",
                data: !1,
                ...
                jsonpCallback: function() {
                  return (_ += 1), "mduijsonp_" + Date.now() + "_" + _;
                },
                contentType: "application/x-www-form-urlencoded",
                timeout: 0,
                global: !0
              },
              r = ["beforeSend", "success", "error", "statusCode", "complete"],
              d = !1,
              u = E,
              l = {};
            c(u, function(t, e) {
            ...
            var f = (e = t.extend({}, s, e)).method.toUpperCase();
            ...
            if (
              ((p =
                ...
                [ArrayBuffer, Blob, Document, FormData].indexOf(
                  ...
                  ? a(e.data)
                    ...
                    : t.param(e.data)
                  : e.data),
              y(f) && p && ((e.url = w(e.url, p)), (p = null)),
              "jsonp" === e.dataType)
            ) {
              var h = o(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                m = w(e.url, e.jsonp + "=" + h);
              if (
                ((l.options = e), n(I.ajaxStart, l), i("beforeSend", null), d)
              )
                return;
              var v,
              ...
              return (
                ...
                (g.onerror = function() {
                  v && clearTimeout(v),
                    n(I.ajaxError, l),
                    i("error", null, "scripterror"),
                    n(I.ajaxComplete, l),
                    i("complete", null, "scripterror");
                }),
                (g.src = m),
                (window[h] = function(e) {
                  v && clearTimeout(v),
                ...
                void (
                  ...
                  (v = setTimeout(function() {
                    t(g).remove(),
                      (g = null),
                      n(I.ajaxError, l),
                      i("error", null, "timeout");
                  }, e.timeout))
                )
              );
            }
            y(f) && !e.cache && (e.url = w(e.url, "_=" + Date.now()));
            var b = new XMLHttpRequest();
            b.open(f, e.url, e.async, e.username, e.password),
              (e.contentType || (p && !y(f) && !1 !== e.contentType)) &&
            ...
            return (
              (b.onload = function() {
                ...
                var t,
                  o,
                  a = (b.status >= 200 && b.status < 300) || 0 === b.status;
                if (a)
                  if (
                    ((t =
                      204 === b.status || "HEAD" === f
                    ...
                    try {
                      (o = JSON.parse(b.responseText)), (l.data = o);
                    } catch (e) {
                      (t = "parsererror"), n(I.ajaxError, l), i("error", b, t);
                    }
                    "parsererror" !== t &&
                      (n(I.ajaxSuccess, l), i("success", o, t, b));
                  } else
                    (o =
                      ...
                      n(I.ajaxSuccess, l),
                      i("success", o, t, b);
                else (t = "error"), n(I.ajaxError, l), i("error", b, t);
                c([u.statusCode, e.statusCode], function(e, n) {
                  n &&
                    n[b.status] &&
                    (a ? n[b.status](o, t, b) : n[b.status](b, t));
                }),
                  n(I.ajaxComplete, l),
                  i("complete", b, t);
              }),
              (b.onerror = function() {
                x && clearTimeout(x),
                  n(I.ajaxError, l),
                  i("error", b, b.statusText),
                  n(I.ajaxComplete, l),
                  i("complete", b, "error");
              }),
              (b.onabort = function() {
                var t = "abort";
                x && ((t = "timeout"), clearTimeout(x)),
                  n(I.ajaxError, l),
                  i("error", b, t),
                  n(I.ajaxComplete, l),
                  i("complete", b, t);
  ...
  e.fn.extend({
    ...
    e.extend({
      showOverlay: function(t) {
        ...
        n.length
          ? (n.data("isDeleted", 0), void 0 !== t && n.css("z-index", t))
          : (void 0 === t && (t = 2e3),
            (n = e('<div class="mdui-overlay">')
    ...
    (function() {
      ...
      e.fn.extend({
        ...
        (t.mutation = function(t, o) {
          "string" == typeof t && "function" == typeof o
            ? ((i[t] = o),
    ...
    (t.Headroom = (function() {
      function t(t, i) {
        ...
        if (((o.$headroom = e(t).eq(0)), o.$headroom.length)) {
          ...
          s !== Object(s) && (o.options.tolerance = { down: s, up: s }),
            o._init();
        }
      }
      var n = {
      ...
      var o = function(t) {
        "pinning" === t.state &&
          ((t.state = "pinned"), r("pinned", "headroom", t, t.$headroom)),
          "unpinning" === t.state &&
            ((t.state = "unpinned"), r("unpinned", "headroom", t, t.$headroom));
      };
      return (
  ...
  var d = (function() {
    ...
    (t.prototype._isOpen = function(t) {
      ...
      (t.prototype._getItem = function(t) {
        var n = this;
        return parseInt(t) === t
          ? n.$collapse.children("." + n.class_item).eq(t)
          : e(t).eq(0);
      });
    ...
    return (
      (t.prototype.open = function(t) {
        ...
        if (!n._isOpen(o)) {
          n.options.accordion &&
            n.$collapse.children("." + n.class_item_open).each(function() {
              var t = e(this);
              t !== o && n.close(t);
            });
  ...
  return (
          ...
          t.$tdRows.each(function() {
            ...
            if ((n.find(".mdui-table-cell-checkbox").remove(), t.selectable)) {
              ...
              n.hasClass("mdui-table-row-selected") &&
                ((o[0].checked = !0), t.selectedRow++),
                (t.$thCheckbox[0].checked = t.selectedRow === t.$tdRows.length),
                o.on("change", function() {
                  o[0].checked
                    ? (n.addClass("mdui-table-row-selected"), t.selectedRow++)
                    : (n.removeClass("mdui-table-row-selected"),
                      t.selectedRow--),
                    (t.$thCheckbox[0].checked =
                      t.selectedRow === t.$tdRows.length);
                }),
          ...
          i.$thRow.find("th").each(function(o, a) {
            (t = e(a)),
              i.$tdRows.each(function() {
                n = e(this);
                var i = t.hasClass("mdui-table-col-numeric")
                  ? "addClass"
                  : "removeClass";
                n.find("td")
                  .eq(o)
                  [i]("mdui-table-col-numeric");
              });
          });
        }),
    ...
    (function() {
      ...
      var i = {
        ...
        show: function(t, n) {
          if (2 !== t.button) {
            var i,
              o = (i = "touches" in t && t.touches.length ? t.touches[0] : t)
                .pageX,
              a = i.pageY,
              s = n.offset(),
      ...
      n.on(a.start, function(t) {
        if (a.isAllow(t) && (a.register(t), t.target !== document)) {
          var n,
            o = e(t.target);
          if (
            (n = o.hasClass("mdui-ripple")
              ? o
              : o.parents(".mdui-ripple").eq(0)).length
          ) {
            ...
            if ("touchstart" === t.type) {
              var s = !1,
                ...
                d = function(e) {
                  r && (clearTimeout(r), (r = null), i.show(t, n)),
                    s || ((s = !0), i.hide(e, n));
                };
              n.on("touchmove", function(t) {
                r && (clearTimeout(r), (r = null)), d(t);
              }).on("touchend touchcancel", d);
            } else
              i.show(t, n),
                n.on(
                  "touchmove touchend touchcancel mousemove mouseup mouseleave",
      ...
      n.on(
        ...
        function(t) {
          ...
          if (
            ...
            if (
              ("focus" === a && u.addClass("mdui-textfield-focus"),
              "blur" === a && u.removeClass("mdui-textfield-focus"),
              ("blur" !== a && "input" !== a) ||
                u[s && "" !== s ? "addClass" : "removeClass"](
                  "mdui-textfield-not-empty"
                ),
              u[n.disabled ? "addClass" : "removeClass"](
                "mdui-textfield-disabled"
              ),
              ("input" !== a && "blur" !== a) ||
                d ||
                (n.validity &&
                  u[n.validity.valid ? "removeClass" : "addClass"](
            ...
            m &&
              ...
              (u.find(".mdui-textfield-helper").length ||
                u.find(".mdui-textfield-error").length ||
                m) &&
                u.addClass("mdui-textfield-has-bottom");
          }
        }
      ),
        n.on(
        ...
        (t.updateTextFields = function() {
          e(arguments.length ? arguments[0] : ".mdui-textfield").each(
            function() {
              e(this)
                .find(".mdui-textfield-input")
        ...
        o = function(t) {
          ...
          t[r ? "addClass" : "removeClass"]("mdui-slider-disabled"),
            ...
            t
              ...
              .append(a);
          var d,
            c = t.hasClass("mdui-slider-discrete");
          c && ((d = e("<span></span>")), a.empty().append(d)),
            t.data({
              $track: n,
              $fill: o,
              $thumb: a,
      ...
      function t(t, o) {
        ...
        if (((s.$fab = e(t).eq(0)), s.$fab.length)) {
          ...
          (s.options = e.extend({}, i, o || {})),
            ...
            "hover" === s.options.trigger &&
              (s.$btn.on("touchstart mouseenter", function() {
                s.open();
              }),
              s.$fab.on("mouseleave", function() {
                s.close();
              })),
            "click" === s.options.trigger &&
              s.$btn.on(a.start, function() {
                s.open();
              }),
            n.on(a.start, function(t) {
          ...
          "opening" !== t.state &&
            ...
            t.$dialBtns.eq(0).transitionEnd(function() {
              t.$btn.hasClass("mdui-fab-opened") &&
                ((t.state = "opened"), r("opened", "fab", t, t.$fab));
            }));
        }),
    ...
    (t.Select = (function() {
        ...
        if (s.length) {
          ...
          s.hide(),
            ...
            n.on("click touchstart", function(t) {
              var n = e(t.target);
              ("opening" !== a.state && "opened" !== a.state) ||
                n.is(a.$select) ||
                e.contains(a.$select[0], n[0]) ||
                a.close();
            });
        }
      }
      var o = { position: "auto", gutter: 16 },
        a = function(t) {
          ...
          if ("auto" === s) {
            var h = o - 2 * a;
            f > h && (f = h), (n = -(u + t.selectedIndex * c + (c - r) / 2));
      ...
      t.prototype.handleUpdate = function() {
        ...
        (t.value = n.val()),
          ...
          (t.$select = e(
            ...
            .show()
            .append(t.$selected)),
          (t.$menu = e('<div class="mdui-select-menu"></div>')
            .appendTo(t.$select)
            .append(t.$items)),
          e("#" + t.uniqueID).remove(),
          n.after(t.$select),
          ...
          t.$select.on("click", function(n) {
            var i = e(n.target);
            i.is(".mdui-select-menu") ||
              i.is(".mdui-select-menu-item") ||
              t.toggle();
          });
      };
      var s = function(t) {
    ...
    e(function() {
      t.mutation("[mdui-select]", function() {
        ...
        i ||
          ((i = new t.Select(n, s(n.attr("mdui-select")))),
    ...
    (t.Tab = (function() {
      ...
      return (
        (t.prototype._bindTabEvent = function(t) {
          var n = this,
            i = e(t),
            a = function(e) {
              o(i)
        ...
        (t.prototype._setActive = function() {
          ...
          t.$tabs.each(function(n, i) {
            var a = e(i),
              s = a.attr("href");
            n !== t.activeIndex || o(a)
              ? (a.removeClass("mdui-tab-active"), e(s).hide())
              : (a.hasClass("mdui-tab-active") ||
                  (r("change", "tab", t, t.$tab, {
                    index: t.activeIndex,
                    id: s.substr(1)
                  }),
                  r("show", "tab", t, a),
            ...
            i.on(
              ...
              e.throttle(function() {
                o()
                  ? (r.overlay &&
                      !r.options.overlay &&
                      (e.hideOverlay(), (r.overlay = !1), e.unlockScreen()),
                    r.$drawer.hasClass("mdui-drawer-close") ||
                      (r.state = "opened"))
                  : r.overlay ||
                    "opened" !== r.state ||
      ...
      var n = { overlay: !1, swipe: !1 },
        ...
        a = function(t) {
          function n(e, n) {
            ...
            t.$drawer.css(
              "cssText",
              "transform:" + i + (n ? "transition: initial !important;" : "")
            );
          }
          function i() {
          ...
          function a(t) {
            return Math.min(
              Math.max("closing" === p ? f - t : o() + f - t, 0),
              o()
            );
          }
          function s(e) {
            (u = e.touches[0].pageX),
              ...
              (l = e.touches[0].pageY),
              ("opened" !== t.state && (u > v || c !== s)) ||
                ((h = !0), m.on({ touchmove: r, touchend: d, touchcancel: r }));
          }
          function r(i) {
          ...
          function d(n) {
            ...
            m.off({ touchmove: r, touchend: d, touchcancel: r });
          }
          var c,
            u,
            l,
            ...
            m = e("body"),
            v = 24;
          t.options.swipe && (c || (m.on("touchstart", s), (c = s)));
        },
        s = function(t) {
          t.$drawer.hasClass("mdui-drawer-open")
            ? ((t.state = "opened"), r("opened", "drawer", t, t.$drawer))
            : ((t.state = "closed"), r("closed", "drawer", t, t.$drawer));
        };
      return (
        (t.prototype.open = function() {
          var t = this;
          "opening" !== t.state &&
            ...
            t.options.overlay ||
              e("body").addClass("mdui-drawer-body-" + t.position),
            t.$drawer
        ...
        (t.prototype.close = function() {
          ...
          "closing" !== t.state &&
            ...
            t.options.overlay ||
              e("body").removeClass("mdui-drawer-body-" + t.position),
            t.$drawer
    ...
    (t.Dialog = (function() {
      function t(t, n) {
        ...
        if (((i.$dialog = e(t).eq(0)), i.$dialog.length)) {
          ...
          if (o) return o;
          e.contains(document.body, i.$dialog[0]) ||
            ((i.append = !0), e("body").append(i.$dialog)),
            (i.options = e.extend({}, c, n || {})),
            (i.state = "closed"),
      ...
      var a,
        ...
        l = function() {
          if (d) {
            ...
            t.height(""), n.height("");
            var a = t.height();
            t.css({ top: (i.height() - a) / 2 + "px", height: a + "px" }),
              n.height(a - (e.height() || 0) - (o.height() || 0));
          }
        },
        f = function() {
          location.hash.substring(1).indexOf("mdui-dialog") < 0 && d.close(!0);
        },
        p = function(t) {
          e(t.target).hasClass("mdui-overlay") && d && d.close();
        },
        h = function(t) {
          t.$dialog.hasClass("mdui-dialog-open")
            ? ((t.state = "opened"), r("opened", "dialog", t, t.$dialog))
            : ((t.state = "closed"),
      ...
      return (
        (t.prototype._doOpen = function() {
          ...
          if (
            ...
            a[t.options.modal ? "off" : "on"]("click", p).css(
              "opacity",
              t.options.overlay ? "" : 0
            ),
            t.options.history)
            ...
            n.indexOf("mdui-dialog") > -1 &&
              (n = n.replace(/[&?]?mdui-dialog/g, "")),
              (location.hash = n
                ? n + (n.indexOf("?") > -1 ? "&" : "?") + "mdui-dialog"
                : "mdui-dialog"),
              i.on("hashchange", f);
          }
        }),
        (t.prototype.open = function() {
          ...
          "opening" !== t.state &&
            "opened" !== t.state &&
            ((d && ("opening" === d.state || "opened" === d.state)) ||
            o.queue(u).length
              ? o.queue(u, function() {
                  t._doOpen();
                })
        ...
        (t.prototype.close = function() {
          ...
          setTimeout(function() {
            "closing" !== t.state &&
              ...
              0 === o.queue(u).length && a && (e.hideOverlay(), (a = null)),
              t.$dialog
              ...
              t.options.history &&
                0 === o.queue(u).length &&
                (n[0] || window.history.back(), i.off("hashchange", f)),
              setTimeout(function() {
                o.dequeue(u);
              }, 100));
          }, 0);
        ...
        (t.prototype.destroy = function() {
          ...
          t.append && t.$dialog.remove(),
            ...
            0 !== o.queue(u).length ||
              d ||
              (a && (e.hideOverlay(), (a = null)),
              s && (e.unlockScreen(), (s = !1)));
        }),
        (t.prototype.handleUpdate = function() {
          l();
        }),
    ...
    (t.dialog = function(n) {
      var i = {
        ...
        o = { text: "", bold: !1, close: !0, onClick: function(t) {} };
      (n = e.extend({}, i, n || {})),
      ...
      return (
        n.buttons.length &&
          r.$dialog.find(".mdui-dialog-actions .mdui-btn").each(function(t, i) {
            e(i).on("click", function() {
              "function" == typeof n.buttons[t].onClick &&
                n.buttons[t].onClick(r),
    ...
    (t.confirm = function(n, i, o, a, s) {
      "function" == typeof i &&
        ((i = ""), (o = arguments[1]), (a = arguments[2]), (s = arguments[3])),
        void 0 === o && (o = function() {}),
        void 0 === a && (a = function() {}),
        void 0 === s && (s = {});
      var r = {
      ...
      return (
        ...
        t.dialog({
          ...
          buttons: [
            ...
            { text: s.confirmText, bold: !1, close: !0, onClick: o }
          ],
    ...
    (t.prompt = function(n, i, o, a, s) {
      ...
      var d =
        ...
        (n ? '<label class="mdui-textfield-label">' + n + "</label>" : "") +
        ("text" === s.type
    ...
    (t.Tooltip = (function() {
      function t(t) {
        ...
        switch (
          ...
          -1 === ["bottom", "top", "left", "right"].indexOf(o) &&
            (o =
              a.top + a.height + s + c + 2 < i.height()
                ? "bottom"
                : s + c + 2 < a.top
                ? "top"
                : s + r + 2 < a.left
                ? "left"
                : a.width + s + r + 2 < i.width() - a.left
                ? "right"
                : "bottom"),
          o)
        ) {
      ...
      var o = { position: "auto", delay: 0, content: "" },
        ...
        c = function(t) {
          t.$tooltip.hasClass("mdui-tooltip-open")
            ? ((t.state = "opened"), r("opened", "tooltip", t, t.$target))
            : ((t.state = "closed"), r("closed", "tooltip", t, t.$target));
        };
      return (
        ...
        (n.prototype.open = function(n) {
          ...
          if ("opening" !== i.state && "opened" !== i.state) {
            ...
            e.extend(i.options, s(i.$target.attr("mdui-tooltip"))),
              ...
              o.content !== i.options.content &&
                i.$tooltip.html(i.options.content),
              t(i),
              i.options.delay
                ? (i.timeoutId = setTimeout(function() {
                    i._doOpen();
                  }, i.options.delay))
                : ((i.timeoutId = !1), i._doOpen());
          }
        }),
    ...
    (function() {
      function i(t, n) {
        var i = this;
        if (
          ((i.message = t), (i.options = e.extend({}, r, n || {})), i.message)
        ) {
          (i.state = "closed"), (i.timeoutId = !1);
          var o = "",
            a = "";
          0 === i.options.buttonColor.indexOf("#") ||
          0 === i.options.buttonColor.indexOf("rgb")
            ? (o = 'style="color:' + i.options.buttonColor + '"')
            : "" !== i.options.buttonColor &&
              (a = "mdui-text-color-" + i.options.buttonColor),
            (i.$snackbar = e(
            ...
            i.$snackbar
              .reflow()
              .addClass("mdui-snackbar-" + i.options.position);
        }
      }
      var s,
        r = {
      ...
      (i.prototype._setPosition = function(t) {
        ...
        (i.prototype.open = function() {
          ...
          t.message &&
            ...
            "opened" !== t.state &&
            (s
              ? o.queue("__md_snackbar", function() {
                  t.open();
                })
              : ((s = t),
                (t.state = "opening"),
                ...
                t.$snackbar.transitionEnd(function() {
                  "opening" === t.state &&
                    ...
                    t.$snackbar.on("click", function(n) {
                      e(n.target).hasClass("mdui-snackbar-action") ||
                        t.options.onClick();
                    }),
                    t.options.closeOnOutsideClick && n.on(a.start, d),
                    t.options.timeout &&
        ...
        (i.prototype.close = function() {
          ...
          t.message &&
            ...
            t.options.closeOnOutsideClick && n.off(a.start, d),
            (t.state = "closing"),
            t.options.onClose(),
    ...
    n.on("click", ".mdui-bottom-nav>a", function() {
      ...
      i.children("a").each(function(o, a) {
        (t = n.is(a)) && r("change", "bottomNav", null, i, { index: o }),
    ...
    (function() {
      var n = function() {
        ...
        i = function(t) {
          var i,
            o = e(t);
          (i = o.hasClass("mdui-spinner-colorful")
            ? n("1") + n("2") + n("3") + n("4")
            : n()),
            o.html(i);
        };
    ...
    (t.Menu = (function() {
      function t(t, s, r) {
        var d = this;
        if (((d.$anchor = e(t).eq(0)), d.$anchor.length)) {
          var c = d.$anchor.data("mdui.menu");
          if (c) return c;
          (d.$menu = e(s).eq(0)),
            d.$anchor.siblings(d.$menu).length &&
              ((d.options = e.extend({}, o, r || {})),
              (d.state = "closed"),
              (d.isCascade = d.$menu.hasClass("mdui-menu-cascade")),
              "auto" === d.options.covered
                ? (d.isCovered = !d.isCascade)
                : (d.isCovered = d.options.covered),
              d.$anchor.on("click", function() {
                d.toggle();
              }),
              n.on("click touchstart", function(t) {
                var n = e(t.target);
                ("opening" !== d.state && "opened" !== d.state) ||
                  n.is(d.$menu) ||
                  e.contains(d.$menu[0], n[0]) ||
                  n.is(d.$anchor) ||
                  e.contains(d.$anchor[0], n[0]) ||
                  d.close();
              }),
              n.on("click", ".mdui-menu-item", function(t) {
                var n = e(this);
                n.find(".mdui-menu").length ||
      ...
      var o = {
        ...
        a = function(t) {
          ...
          if (
            ...
            (r = "100%"), (n = (l ? x : 0) + (f ? g - h : C - h));
          else {
            r = "50%";
            var O = h;
            t.isCascade ||
              (h + 2 * u > d && ((O = d - 2 * u), t.$menu.height(O))),
              (n = (d - O) / 2 + (f ? 0 : C - g));
          }
          if ((t.$menu.css("top", n + "px"), "left" === a))
            (s = "0"), (e = f ? b : k);
          else if ("right" === a) (s = "100%"), (e = f ? b + y - p : k + y - p);
          else {
            s = "50%";
            var T = p;
            p + 2 * u > c && ((T = c - 2 * u), t.$menu.width(T)),
              (e = (c - T) / 2 + (f ? 0 : k - b));
          }
        ...
        s = function(t) {
          var e,
            ...
            v = p.left,
            g = p.top;
          (o = c - g > f ? "bottom" : g + m > f ? "top" : "bottom"),
        ...
        u = function(t) {
          t.hasClass("mdui-menu-open") ? c(t) : d(t);
        },
        l = function(t) {
          if (
              ...
              if (null === s.attr("disabled")) {
                ...
                if ("mouseover" === r) {
                  if (l.length) {
                    ...
                    if ((f && clearTimeout(f), l.hasClass("mdui-menu-open")))
                      return;
                    clearTimeout(i),
      ...
      var f = function(t) {
        t.$menu.removeClass("mdui-menu-closing"),
          "opening" === t.state &&
            ((t.state = "opened"), r("opened", "menu", t, t.$menu)),
          "closing" === t.state &&
            ((t.state = "closed"),
