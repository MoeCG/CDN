  ...
  function e(e, a, r) {
    return (
      ...
      this.on("click.pjax", e, function(e) {
        var a = r;
        a.container ||
          ((a = t.extend({}, r)), (a.container = t(this).attr("data-pjax"))),
          n(e, a);
      })
    );
  }
    ...
    if (
      ...
      o.trigger(u, [s]),
        u.isDefaultPrevented() ||
          (r(s), e.preventDefault(), o.trigger("pjax:clicked", [s]));
    }
  }
  function a(e, n, a) {
    a = m(n, a);
    ...
    (e.beforeSend = function(t, r) {
      ...
      (e.success = function(i, s, u) {
        var p = r.state,
          ...
          m = g(i, u, e),
          v = f(m.url);
        if ((a && ((v.hash = a), (m.url = v.href)), d && h && d !== h))
          return void o(m.url);
        ...
        (r.state = {
          ...
          (e.push || e.replace) &&
            window.history.replaceState(r.state, m.title, m.url);
  ...
  function s(e) {
    ...
    if ("string" == typeof i)
      ...
      t.each(i, function(e, n) {
        r.append(
          t("<input>", { type: "hidden", name: n.name, value: n.value })
        );
      });
